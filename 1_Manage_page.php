                    ...
                    <?php if(!empty($arr_users)) { ?>
                        <?php foreach($arr_users as $user) { ?>
                            <tr>
                                ...
                                <td><img src="upload/<?php echo $user['photo']?> width='35' height='35' "></td>
                                <td><?php echo "<a class='btn btn-primary btn-sm' href='./1_Edit.php?Id_card_number=$user[Id_card_number]' >編輯客戶資料</a> 
                                                <a class='btn btn-danger btn-sm' href='./1_Delete.php?Id_card_number=$user[Id_card_number]' >停用客戶資料</a> 
                                    ";?>
                                </td>
                            </tr>
                        <?php } ?>
