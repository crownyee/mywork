    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <div class="recent--patients">
                <div class="title">
                    <h2 class="section--title">應收帳款資料列表</h2>
                </div>
                <div class="table">
                <a class="btn btn-primary"href="./4_Create.php" role="button">新增收帳資料</a>
                    ...
                    <?php if(!empty($arr_users)) { ?>
                        <?php foreach($arr_users as $user) { ?>
                            <tr>
                                ...
                                <td><?php echo "<a class='ri-edit-line edit' href='./4_Edit.php?ID=$user[ID]'></a> 
                                    ";?>
                                </td>
                            </tr>
                        <?php } ?>
